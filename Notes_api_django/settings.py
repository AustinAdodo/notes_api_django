"""
Django's settings for Notes_api_django project.
...
SECRET_KEY = 'django-insecure-3j_cff+c^=e7dpl1njwccmzsem@-p!kpp^ve)1a^vx+t=s5=3x'
...
ROOT_URLCONF = 'Notes_api_django.urls'
...
WSGI_APPLICATION = 'Notes_api_django.wsgi.application'
...
#         'HOST': 'localhost',  # Use the database server host
